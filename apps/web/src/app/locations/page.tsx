    ...
    <div className="min-h-screen bg-naploo-dark text-white">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="max-w-xl mx-auto">
            <div className="flex gap-3">
              ...
              <button className="px-6 py-4 bg-gradient-to-r from-primary-500 to-violet-600 rounded-xl hover:shadow-glow transition-all">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-8">
            {locations.map((location) => (
              <div key={location.city} className="glass-card rounded-2xl p-6">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-white/50">{location.state}</p>
                  </div>
                  <span className="ml-auto px-3 py-1 bg-emerald-500/20 text-emerald-400 rounded-full text-sm">
                  ...
                  {location.spots.map((spot) => (
                    ...
                    >
                      ...
                      <div className="text-right">
                        ...
                        <p className="text-sm text-white/50">{spot.pods} pods</p>
                      </div>
                    </Link>
                  ))}
                </div>
      ...
      <section className="relative py-16 bg-white/[0.02]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-white/60 mb-8">We&apos;re expanding to these cities in 2026</p>
          <div className="flex flex-wrap justify-center gap-3">
            {upcomingCities.map((city) => (
              <span
                key={city}
                className="px-4 py-2 bg-white/5 border border-white/10 rounded-full text-white/60"
              >
                {city}
              </span>
            ))}
